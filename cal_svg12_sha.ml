...
let () =
  ...
  add_blur_filter svg ~id:"filter12" ~stdDeviation:5.0 ();
  ...
  add_text svg ~x:14 ~y:18 ~text_anchor:"left" ~font_family:"sans-serif" ~font_size:9.6 ~font_weight:"bold" ~fill:"#68D" ~text ();
  add_newline svg;
  ...
  for mon = 1 to 12 do  (* for each month *)
    ...
    add_rect svg ~x:(-2) ~y:9 ~width:225 ~height ~rx:16.0 ~ry:16.0 ~fill:"#000" ~fill_opacity:0.7 ~stroke:"#000" ~stroke_width:0.0 ~filter:"url(#filter12)" ();
    add_rect svg ~x:0    ~y:6 ~width:225 ~height ~rx:16.0 ~ry:16.0 ~fill:"#FFF" ~fill_opacity:1.0 ~stroke:"#222" ~stroke_width:0.0 ();

    (* Month label *)
    let text = String.capitalize_ascii months.(pred mon) in
    add_text svg ~x:110 ~y:26 ~text_anchor:"middle" ~font_family:"sans-serif" ~font_size:15.6 ~font_weight:"bold" ~fill:"#46C" ~fill_opacity:0.8 ~text ();
    add_newline svg;
    ...
    for i = 0 to 6 do
      ...
      add_text svg ~x ~y:44 ~text_anchor:"middle" ~font_family:"sans-serif" ~font_size:9.4 ~font_weight:"bold" ~fill:"#028" ~text ();
    done;
    add_newline svg;
